...
(function () {
  const NEWS = {
    "1": {
      ...
      alt: "صورة الخبر 1",
      title: 'تشرفت #شركة_الشرق_للتجارة_والتوكيلات " بالمشاركة الفعّالة في فعاليات المؤتمر العاشر لجراحة العظام، الذي عُقد في جامعة جبلة بمحافظة إب خلال يومي 20 و21 أغسطس 2025م.',
...
#المؤتمر_العاشر_لجراحة_العظام "`
  ...
  window.lpInitNewsDetails = function lpInitNewsDetails() {
    ...
    // title in tab
    document.title = (item.title ? item.title + " | شركة الشرق" : "تفاصيل الخبر | شركة الشرق");
